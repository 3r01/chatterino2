...
TEST_F(TestIgnoreController, processIgnorePhrases)
{
    ...
    std::vector<TestCase> testCases{
        ...
        {
            .phrases = {regularReplace("foo", "foobar")},
            .input = "foo [GIF]",
            .twitchSpecials = {gifAt(4)},
            .expectedMessage = "foobar [GIF]",
            .expectedTwitchSpecials = {gifAt(7)},
        },
        {
            .phrases = {regularReplace("GIF", "image")},
            .input = "[GIF] foo",
            .twitchSpecials = {gifAt(0)},
            .expectedMessage = "[image] foo",
            .expectedTwitchSpecials = {},
        },
        {
            .phrases = {regexReplace("(?<=G)(?=I)", "x")},
            .input = "[GIF]",
            .twitchSpecials = {gifAt(0)},
            .expectedMessage = "[GxIF]",
            .expectedTwitchSpecials = {},
        },
    };
